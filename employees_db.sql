...
CREATE TABLE `employees` (
  `id` int(10) UNSIGNED NOT NULL,
  `ic` varchar(60) COLLATE utf8mb4_unicode_ci NOT NULL,
  `firstname` varchar(60) COLLATE utf8mb4_unicode_ci NOT NULL,
  `jawatan` varchar(60) COLLATE utf8mb4_unicode_ci NOT NULL,
  `middlename` varchar(120) COLLATE utf8mb4_unicode_ci NOT NULL,
  `city_id` int(11) NOT NULL,
  `state_id` int(11) NOT NULL,
  `country_id` int(11) NOT NULL,
  `zip` char(10) COLLATE utf8mb4_unicode_ci NOT NULL,
  `age` int(11) NOT NULL,
  `lantikanpertama` date NOT NULL,
  `pengesahanpertama` date NOT NULL,
...
INSERT INTO `users` (`id`, `username`, `email`, `password`, `ic`, `firstname`, `remember_token`, `deleted_at`, `created_at`, `updated_at`) VALUES
