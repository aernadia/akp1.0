...
class EmployeeManagementController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $keys = ['nokadpengenalan', 'firstname', 'jawatan', 'address', 'city_id', 'state_id', 'country_id', 
        'lantikanpertama', 'pengesahanpertama', 'lantikansemasa', 'department_id', 'division_id'];
    ...
    private function validateInput($request) {
        $this->validate($request, [
            'nokadpengenalan' => 'required|max:60',
            'firstname' => 'required|max:60',
            'jawatan' => 'required|max:60',
            'address' => 'required|max:120',
            'country_id' => 'required',
            // 'zip' => 'required|max:10',
            // 'age' => 'required',
            'lantikanpertama' => 'required',
            'lantikansemasa' => 'required',
            'pengesahanpertama' => 'required',
