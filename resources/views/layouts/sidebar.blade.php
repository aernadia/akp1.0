    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        <div class="pull-left image">
          <img src="{{ asset("/bower_components/AdminLTE/dist/img/ayu.jpg") }}" class="img-circle" alt="User Image">
        </div>
      ...
      <ul class="sidebar-menu">
        ...
        <li><a href="{{ url('employee-management') }}"><i class="fa fa-link"></i> <span>AKP PPDLD</span></a></li>
        <li><a href="{{ url('employee-management-school') }}"><i class="fa fa-link"></i> <span>Senarai AKP Sekolah</span></a></li>
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="{{ url('system-management/school') }}">School</a></li>
            <li><a href="{{ url('system-management/gred') }}">Gred</a></li>
